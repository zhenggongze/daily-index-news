...
示例21 — 不相关（关键：字节组织架构调整不含算力关键词就是HR行为）：
标题：时隔四年，字节跳动新调整
相关：false | 影响：无
理由：纯组织架构调整/人事变动，不涉及AI算力产业链
说明：标题中"新调整"、"调整组织架构"、"调整"但没有"算力基建部"、"GPU采购"、"数据中心"、"算力"等硬词时，一律判不相关。只有明确提到设立算力部门、AI基础设施投资时才判相关。

示例22 — 不相关（关键：公司捐款/慈善/社会责任行为）：
标题：美光科技宣布投入 2.5 亿美元，通过"特朗普账户"助力百万儿童储蓄
相关：false | 影响：无
理由：慈善捐款行为，与存储芯片/算力产业链无关
说明：即使公司是半导体公司（美光/台积电/英伟达/SK海力士等），捐赠、慈善、社会责任活动不属于产业动态，一律判不相关。

示例23 — 不相关（关键：公司Bug修复/故障恢复）：
标题：OpenAI 修复 Codex 额度消耗异常故障，并再次重置用户额度
相关：false | 影响：无
理由：Bug修复/故障恢复，不涉及AI算力产业链
说明：API服务的Bug修复、服务故障恢复、额度调整等属于运维事件，不是产业动态。

示例24 — 不相关（关键：无人机/相机等硬件）：
标题：大疆无人机 DJI Fly 鸿蒙版 App 正式上架华为应用市场
相关：false | 影响：无
理由：无人机App上架，与AI芯片/算力产业链无关
说明：即使上架的是"鸿蒙版"，无人机、相机等硬件及其配套软件不涉及AI算力产业链。

示例25 — 不相关（关键：支付/金融产品）：
标题：银联推出AI智算卡：银行卡开始「外挂」大模型
相关：false | 影响：无
理由：银行卡/金融产品，与AI算力产业链无关
说明：支付卡、银行卡、金融产品即使名称含"AI"/"智算"，只要实质是金融消费产品而非AI算力硬件，一律判不相关。

示例26 — 不相关（关键：新产品外观曝光/谍照）：
标题：刚刚，Codex 首款硬件曝光
相关：false | 影响：无
理由：产品外观曝光/谍照，无实质配置或产业信息
